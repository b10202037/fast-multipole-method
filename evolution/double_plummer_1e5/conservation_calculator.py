...
if __name__ == "__main__":
    ...
    for i in range(1001):
        ...
        datafile = f'particles_{method}/double_plummer_2e5_step{i}.bin'
        U, K, Px, Py, Pz, Ne =calculate_potential_energy_gpu(filename=datafile, n_particles=200_000)
        summary.append({
            "i": i,
            "U": U,
            "K": K,
    ...
    df_summary.to_csv(f"conservation/conservation_results_alpha{alpha}_{method}_1000.csv", index=False)
    print(df_summary)